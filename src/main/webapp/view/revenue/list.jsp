...
<c:if test="${role == 2}">
    <center>
        <div class="col">
            <h2 class="header-table"><a style="text-decoration: none" href="/revenue">List Of Revenues</a> </h2>
            <div>
                <center>
                    <div align="center">
...
<center>
    <a style="align-items: center" class="btn btn-primary" href="revenue?action=create" role="button">Add New Revenue</a>
</center>
