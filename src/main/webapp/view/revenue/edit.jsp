...
<div align="center">
    ...
    <form method="post" style="width: 50%">
        ...
        <div class="input-group mb-3">
            <span class="input-group-text" id="inputGroup-sizing-default">Revenue Type:</span>
            <input name="type" id="type"  type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" value="<c:out value='${revenue.type}'/>">
        </div>
            ...
            <c:if test="${role == 1}">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="date" name="date" id="date" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" value="<c:out value='${revenue.date}'/>" >
                </div>
            </c:if>
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" name="description" id="description" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" value="<c:out value='${revenue.description}'/>">
        </div>

            <c:if test="${role == 1}">
                <div class="input-group mb-3">
                    <span class="input-group-text" >Account ID:</span>
                    <input type="text" name="account_id" id="account_id" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" value="<c:out value='${revenue.getAccount().getId()}'/>">
                </div>
            </c:if>
